-- Base schema with source_url added to products
...
CREATE TABLE IF NOT EXISTS public.products (
    ...
    image_url TEXT,
    images TEXT[] DEFAULT '{}',
    -- link fonte para scraping (ex: URL completa do ML)
    source_url TEXT,
    affiliate_link TEXT,
    instructions TEXT,
...
-- Limpa políticas antes de recriar
...
DROP POLICY IF EXISTS "Users manage own assets" ON public.athlete_assets;
...
CREATE POLICY "Users manage own assets" ON public.athlete_assets FOR ALL USING (auth.uid() = user_id);
