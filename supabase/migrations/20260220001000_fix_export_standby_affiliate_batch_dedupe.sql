-- Fix export batch dedupe to prioritize source permalink/catalog id over external_id.
-- This avoids repeated source URLs in the 30-link affiliate validation flow.
...
begin
  ...
  with pending_raw as (
    select
      ...
      coalesce(
        -- Primary dedupe key: ML source permalink/catalog id.
