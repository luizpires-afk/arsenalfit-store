...
declare
  ...
  v_fallback_confirm_window interval := interval '8 hours';
...
begin
      ...
      case
        ...
        when l.last_api_base_at is null
          and not (
            ...
            and f.last_fallback_at is not null
          )
  ...
  return jsonb_build_object(
    ...
    'fallback_confirm_window_hours', 8,
    'affiliate_check_mode', 'api_or_recent_fallback_for_sec_validated'
  );
end;
$$;
