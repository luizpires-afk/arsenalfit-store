    ...
    <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-background/95 backdrop-blur-md supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-20 items-center justify-between px-4">
        ...
        <Link to="/" className="flex items-center gap-3 group shrink-0">
          <div className="bg-primary text-black font-black rounded-2xl h-10 w-10 flex items-center justify-center text-xl rotate-3 group-hover:rotate-0 transition-all shadow-lg shadow-primary/25">
            A
          </div>
          <span className="font-black text-2xl tracking-tighter uppercase italic hidden xs:block">
            <span className="text-zinc-900 dark:text-white">ARSENAL</span>
