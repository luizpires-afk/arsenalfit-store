...
RUNNER_COMMAND="npm run recalculate_product_scores_auto"
LOG_FILE="$PROJECT_ROOT/logs/score-recalc-24h-cron.log"
MARKER="# SCORE_RECALC_24H_CRON"

CRON_TIME_DEFAULT="15 3 * * *"
